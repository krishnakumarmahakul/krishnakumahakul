...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "group flex gap-6 flex-1 list-none items-center justify-center space-x-1",
      className
    )}
    {...props}
  />
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-gray-300 px-4 py-2 text-sm font-medium text-slate-900 transition-colors hover:bg-gray-200 focus:bg-gray-200 focus:text-slate-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-gray-100 data-[state=open]:bg-gray-100"
)
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-slate-300 shadow-md" />
  </NavigationMenuPrimitive.Indicator>
))
